<template>
  <div class="image-container">
    <el-watermark v-if="optsType === 'text'" class="img-watermark" :content="watermarkOps.content.split('|')"
      :font="watermarkOps.font" :rotate="watermarkOps.rotate" :gap="watermarkOps.gap" :offset="watermarkOps.offset">
      <img :src="src" class="image-viewer" @error="defaultFailImage" />
    </el-watermark>
    <el-watermark v-else class="img-watermark" :width="watermarkOps.watermarkImg.width"
      :height="watermarkOps.watermarkImg.height" :image="watermarkOps.watermarkImg.url" :rotate="watermarkOps.rotate"
      :gap="watermarkOps.gap" :offset="watermarkOps.offset">
      <img :src="src" class="image-viewer" @error="defaultFailImage" />
    </el-watermark>
    <div class="tools" @click.prevent.stop="">
